...
import udodog.goGetterServer.model.dto.response.nationwidelibraryinfo.NationwidelibraryInfoDetailResponseDto;
...
public class NationwideLibraryInfoController {
    ...
    // 전국 도서관 정보 삭제 관련 API
    @DeleteMapping("/api/admin/library/delete/{nationwideLibraryInfolibraryInfoId}")
    public ResponseEntity<EntityModel<DefaultRes<NationwidelibraryInfoDetailResponseDto>>> deleteLibraryInfo (@PathVariable("nationwideLibraryInfolibraryInfoId") Long nationwideLibraryInfolibraryInfoId) {
        return new ResponseEntity<>(nationwidelibraryInfoConverter.toModel(nationwidelibraryInfoService.deleteLibraryInfo(nationwideLibraryInfolibraryInfoId)), HttpStatus.OK);
    }
