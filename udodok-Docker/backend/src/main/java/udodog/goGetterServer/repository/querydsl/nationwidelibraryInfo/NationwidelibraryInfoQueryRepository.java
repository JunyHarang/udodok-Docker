...
public class NationwidelibraryInfoQueryRepository {
    ...
    // 전국 도서관 정보 삭제 처리
    @Transactional
    public void deleteByLibraryId(Long libraryInfoId) {

        JPADeleteClause deleteClause = new JPADeleteClause(entityManager, nationwideLibraryInfo);

        deleteClause.where(nationwideLibraryInfo.libraryInfoId.eq(libraryInfoId)).execute();
